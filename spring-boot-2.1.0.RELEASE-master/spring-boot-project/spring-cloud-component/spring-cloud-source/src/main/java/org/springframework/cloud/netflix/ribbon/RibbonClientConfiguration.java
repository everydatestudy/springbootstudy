...
@Import({ HttpClientConfiguration.class, OkHttpRibbonConfiguration.class, RestClientRibbonConfiguration.class,
...
public class RibbonClientConfiguration {
	...
	// TODO: maybe re-instate autowired load balancers: identified by name they
	// could be
	...
	static class OverrideRestClient extends RestClient {
		...
		protected Client apacheHttpClientSpecificInitialization() {
			...
			apache.getClientHandler().getHttpClient().getParams().setParameter(ClientPNames.COOKIE_POLICY,
