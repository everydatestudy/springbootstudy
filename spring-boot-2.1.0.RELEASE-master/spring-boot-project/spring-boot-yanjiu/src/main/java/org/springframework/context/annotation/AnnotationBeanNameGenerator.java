 ...
 */
//对两种bean定义方式，spring提供了两种不同的bean name实现方式去实现不同的模式。
//AnnotationBeanNameGenerator能够处理 Component，Respository，Service，Controller这四个常用的注解，
//解析为bean name注给他们对应的value属性。另外jee的javax.annotation.ManagedBean和javax.inject.Named也可以支持。
