 ...
 *
 * <p>
 * Derives from the {@link TransactionAspectSupport} class which contains the
 * integration with Spring's underlying transaction API. TransactionInterceptor
 * simply calls the relevant superclass methods such as
...
public class TransactionInterceptor extends TransactionAspectSupport implements MethodInterceptor, Serializable {
	 ...
	 * Create a new TransactionInterceptor.
	 * 
	 * @param ptm        the default transaction manager to perform the actual
