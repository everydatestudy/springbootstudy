 ...
 * 值得注意的是OnWebApplicationCondition同样重写了SpringBootCondition的getMatchOutcome方法，
 * 用来判断当前应用是否web应用。同时是OnWebApplicationCondition是@ConditionalOnWebApplication的条件类。
