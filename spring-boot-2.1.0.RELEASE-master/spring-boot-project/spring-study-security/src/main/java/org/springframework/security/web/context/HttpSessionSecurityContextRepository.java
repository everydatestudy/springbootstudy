 ...
 * @since 3.0
 */
//Spring Security Web提供的类HttpSessionSecurityContextRepository
//是一个SecurityContextRepository接口的实现，用于在HttpSession中保存安全上下文(security context)，
//这样属于同一个HttpSession的多个请求，就能够利用此机制访问同一安全上下文了。
//————————————————
//版权声明：本文为CSDN博主「安迪源文」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//原文链接：https://blog.csdn.net/andy_zhang2007/article/details/84714409
