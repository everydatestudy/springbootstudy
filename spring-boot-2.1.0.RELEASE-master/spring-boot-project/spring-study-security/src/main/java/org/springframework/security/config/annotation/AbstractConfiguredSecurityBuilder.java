...
public abstract class AbstractConfiguredSecurityBuilder<O, B extends SecurityBuilder<O>>
	...
	private void init() throws Exception {
		...
		//这里第一次configurers这个属性包含了一个默认SpringBootWebSecurityConfiguration$DefaultConfigurerAdapter，这里是默认的没有写自己的配置
		//这里的configurer这个是 WebSecurityConfigurerAdapter这个对象
		//第二次
		//[org.springframework.security.config.annotation.authentication.configuration.AuthenticationConfiguration$EnableGlobalAuthenticationAutowiredConfigurer@6ada9c0c, 
		//org.springframework.security.config.annotation.authentication.configuration.InitializeAuthenticationProviderBeanManagerConfigurer@6e7c351d, 
		//org.springframework.security.config.annotation.authentication.configuration.InitializeUserDetailsBeanManagerConfigurer@7412ed6b]
		//这个是第三次
		//[org.springframework.security.config.annotation.web.configurers.CsrfConfigurer@5b3bb1f7,
		//org.springframework.security.config.annotation.web.configurers.ExceptionHandlingConfigurer@58d6b7b9, 
		//org.springframework.security.config.annotation.web.configurers.HeadersConfigurer@3f1a4795,
		//org.springframework.security.config.annotation.web.configurers.SessionManagementConfigurer@6a6f6c7e,
		//org.springframework.security.config.annotation.web.configurers.SecurityContextConfigurer@6c5ddccd,
		//org.springframework.security.config.annotation.web.configurers.RequestCacheConfigurer@1dbd580,
		//org.springframework.security.config.annotation.web.configurers.AnonymousConfigurer@6c101cc1, 
		//org.springframework.security.config.annotation.web.configurers.ServletApiConfigurer@7d0d91a1, 
		//org.springframework.security.config.annotation.web.configurers.DefaultLoginPageConfigurer@7fb48179,
		//org.springframework.security.config.annotation.web.configurers.LogoutConfigurer@201c3cda, 
		//org.springframework.security.config.annotation.web.configurers.ExpressionUrlAuthorizationConfigurer@4c86da0c,
		//org.springframework.security.config.annotation.web.configurers.FormLoginConfigurer@5d97caa4,
		//org.springframework.security.config.annotation.web.configurers.HttpBasicConfigurer@6732726]
